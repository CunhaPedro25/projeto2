<template>
  <div class="h-screen flex flex-col relative bg-gray-200 transition-[width] shadow-xl z-50 w-20">
    <div class="flex bg-gray-200 border-b-2 border-gray-300 h-16 items-center px-8 py-4 overflow-hidden gap-0 w-20">
